...
public class LightsTests {
	...
	public void sphereDirectional() {
		...
		camera1.setMyImage(imageWriter) //
				.setMyRayTracer(new RayTracerBasic(scene1)) //
				.renderImage(); //
	...
	public void trianglesDirectional() {
		...
		camera2.setMyImage(imageWriter) //
				.setMyRayTracer(new RayTracerBasic(scene2)) //
				.renderImage(); //
	...
	public void trianglesSpot() {
	  ...
	  /**
     * Produce a picture of a sphere lighted by a combined light
     */
    @Test
    public void sphereCombined() {
    	scene1.geometries.add(sphere);
     	scene1.lights.add(new SpotLight(new Color(90, 567, 30), new Point(-50, -50, 25),new Vector(1, 1, -2)).setkL(0.00008).setkQ(0.0001));
    	
		scene1.lights.add(new PointLight(new Color(800, 500, 0), new Point(50, 50, -25)).setkL(0.0001).setkQ(0.00008));
		scene1.lights.add(new DirectionalLight(new Color(30, 0, 780), new Vector(50, -60, -20)));
		
		ImageWriter imageWriter = new ImageWriter("lightSphereCombinedLighting", 500, 500);
		camera1.setMyImage(imageWriter) //
				.setMyRayTracer(new RayTracerBasic(scene1)) //
				.renderImage(); //
				camera1.writeToImage(); //
    ...
    /**
     * Produce a picture of a two triangles lighted by a combined light
     */
   
    @Test
    public void trianglesCombined() {
    	scene2.geometries.add(triangle1, triangle2);
    	scene2.lights.add(new DirectionalLight(new Color(300, 200, 250), new Vector(-1, 1, 1)));
		scene2.lights.add(new SpotLight(new Color(400, 0, 550), new Point(30, 10, -130), new Vector(1, -2, -2)).setkL(0.0006).setkQ(0.00098));
		scene2.lights.add(new PointLight(new Color(600, 0, 250), new Point(90, -40, -70)).setkL(0.000008).setkQ(0.00067));
		ImageWriter imageWriter = new ImageWriter("lightTrianglesCombinedLight", 500, 500);
		camera2.setMyImage(imageWriter) //
				.setMyRayTracer(new RayTracerBasic(scene2)) //
				.renderImage(); //
		camera2.writeToImage(); //
